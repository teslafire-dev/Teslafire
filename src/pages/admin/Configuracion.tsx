...
const categories = [
  ...
  { id: 'hero', name: 'Contenido del Hero', icon: Type, keys: ['hero_h1', 'hero_p', 'hero_imagen_url', 'hero_video_url'] },
  ...
  { id: 'espanol', name: 'Contenido Español (Dynamic)', icon: Languages, keys: [
    'es_nav_home', 'es_nav_productos', 'es_nav_servicios', 'es_nav_nosotros', 'es_nav_contacto',
    'es_hero_title', 'es_hero_subtitle', 'es_hero_cta', 'es_search_placeholder', 'es_cart_empty',
    'es_footer_description', 'es_toast_theme_dark', 'es_toast_theme_light', 'es_common_buy',
    'es_common_view', 'es_product_similar', 'es_admin_panel', 'es_profile_my_account',
    'es_profile_history', 'es_common_close', 'es_common_price', 'es_common_quantity',
    'es_nosotros_history_tag', 'es_nosotros_history_title', 'es_nosotros_history_desc',
    'es_nosotros_values_quality_title', 'es_nosotros_values_quality_desc',
    'es_nosotros_values_tech_title', 'es_nosotros_values_tech_desc',
    'es_nosotros_values_team_title', 'es_nosotros_values_team_desc',
    'es_nosotros_commitment_title', 'es_nosotros_commitment_l1', 'es_nosotros_commitment_l2',
    'es_nosotros_commitment_l3', 'es_nosotros_commitment_l4',
    'es_nosotros_stats_years', 'es_nosotros_stats_clients', 'es_nosotros_stats_products', 'es_nosotros_stats_brands',
    'es_nosotros_contact_support', 'es_nosotros_contact_title', 'es_nosotros_contact_desc',
    'es_nosotros_contact_info_address_title', 'es_nosotros_contact_info_address_val',
    'es_nosotros_contact_info_phone_title', 'es_nosotros_contact_info_phone_val',
    'es_nosotros_contact_info_email_title', 'es_nosotros_contact_info_email_val',
    'es_nosotros_form_name', 'es_nosotros_form_name_placeholder', 'es_nosotros_form_email',
    'es_nosotros_form_email_placeholder', 'es_nosotros_form_subject', 'es_nosotros_form_subject_placeholder',
    'es_nosotros_form_message', 'es_nosotros_form_message_placeholder', 'es_nosotros_form_submit',
    'es_nosotros_form_sending', 'es_nosotros_form_whatsapp_hint',
    'es_home_hero_tag', 'es_home_hero_title', 'es_home_hero_subtitle', 'es_home_hero_stats_products',
    'es_home_hero_stats_delivery', 'es_home_hero_stats_brands', 'es_home_hero_cta_catalog',
    'es_home_hero_cta_company', 'es_home_categories_title', 'es_home_categories_subtitle',
    'es_home_categories_view_all', 'es_home_featured_title', 'es_home_featured_subtitle',
    'es_home_featured_cta', 'es_home_trust_cert_title', 'es_home_trust_cert_desc',
    'es_home_trust_delivery_title', 'es_home_trust_delivery_desc', 'es_home_trust_stock_title',
    'es_home_trust_stock_desc', 'es_home_trust_support_title', 'es_home_trust_support_desc',
    'es_product_unit_price', 'es_product_get_quote', 'es_product_in_stock', 'es_product_no_description',
    'es_product_add_to_cart', 'es_product_no_similar_products', 'es_product_recommendations',
    'es_product_similar_title_1', 'es_product_similar_title_2', 'es_product_view_full_catalog',
    'es_cart_units_added', 'es_cart_unit_added', 'es_cart_empty_title', 'es_cart_empty_desc',
    'es_cart_empty_cta', 'es_product_not_found', 'es_product_not_found_desc', 'es_back_to_catalog',
    'es_cart_go_to_cart', 'es_cart_title', 'es_cart_subtitle', 'es_cart_continue_shopping',
    'es_cart_sku_label', 'es_cart_price_quote', 'es_cart_help_title', 'es_cart_help_desc',
    'es_cart_chat_expert', 'es_cart_summary_title', 'es_cart_subtotal', 'es_cart_total_label',
    'es_cart_total_usd_ref', 'es_cart_total_bs', 'es_cart_quote_disclaimer', 'es_cart_certification_label',
    'es_cart_finalize_btn', 'es_catalog_filters', 'es_catalog_clear', 'es_catalog_categories',
    'es_catalog_all_categories', 'es_catalog_price_range', 'es_catalog_min_price', 'es_catalog_max_price',
    'es_catalog_filter_disclaimer', 'es_catalog_brands', 'es_catalog_title', 'es_catalog_showing_results',
    'es_catalog_sort_newest', 'es_catalog_sort_price_asc', 'es_catalog_sort_price_desc', 'es_catalog_sort_popularity',
    'es_catalog_loading', 'es_catalog_no_products', 'es_catalog_no_products_desc', 'es_catalog_end',
    'es_footer_tagline', 'es_footer_categories_title', 'es_footer_category_gloves', 'es_footer_category_helmets',
    'es_footer_category_hearing', 'es_footer_category_height', 'es_footer_category_footwear',
    'es_footer_info_title', 'es_footer_link_about', 'es_footer_link_services', 'es_footer_link_contact',
    'es_footer_link_terms', 'es_footer_link_privacy', 'es_footer_contact_title', 'es_footer_address',
    'es_footer_copyright', 'es_footer_iso', 'es_footer_phone', 'es_footer_email', 'es_profile_title',
    'es_profile_subtitle', 'es_profile_user_id', 'es_profile_identity_data', 'es_profile_name',
    'es_profile_last_name', 'es_profile_phone', 'es_profile_save', 'es_profile_security',
    'es_profile_email', 'es_profile_password_change', 'es_profile_password_hint', 'es_profile_new_password',
    'es_profile_confirm_password', 'es_profile_update_access', 'es_profile_protected_status',
    'es_profile_protected_description', 'es_profile_back_to_shop', 'es_reservation_title',
    'es_reservation_subtitle', 'es_reservation_back_to_cart', 'es_reservation_details_title',
    'es_reservation_total_estimated', 'es_reservation_legal_info', 'es_reservation_legal1',
    'es_reservation_legal2', 'es_reservation_legal3', 'es_reservation_legal4', 'es_reservation_form_name',
    'es_reservation_form_name_placeholder', 'es_reservation_form_phone', 'es_reservation_form_phone_placeholder',
    'es_reservation_form_email', 'es_reservation_form_email_placeholder', 'es_reservation_form_id',
    'es_reservation_form_id_placeholder', 'es_reservation_form_requirements',
    'es_reservation_form_requirements_placeholder', 'es_reservation_form_terms', 'es_reservation_form_confirm',
    'es_reservation_form_processing', 'es_reservation_form_secure', 'es_reservation_form_marketing',
    'es_reservation_form_declare', 'es_reservation_form_total_amount', 'es_success_title', 'es_success_subtitle',
    'es_success_download_pdf', 'es_success_share_whatsapp', 'es_success_localizer_title', 'es_success_copy',
    'es_success_copied', 'es_success_reserved_equipment', 'es_success_validation_hint', 'es_success_different_items',
    'es_success_confirmation_title', 'es_success_confirmation_desc', 'es_success_pickup_title', 'es_success_pickup_desc',
    'es_success_digital_box_title', 'es_success_digital_box_desc', 'es_success_continue_shopping',
    'es_success_go_home', 'es_success_loading_master', 'es_success_generating_pdf', 'es_success_copy_toast',
    'es_success_fetching_record', 'es_solutions_tagline', 'es_solutions_title', 'es_solutions_description',
    'es_solutions_mineria_title', 'es_solutions_mineria_desc', 'es_solutions_construccion_title',
    'es_solutions_construccion_desc', 'es_solutions_quimica_title', 'es_solutions_quimica_desc',
    'es_solutions_seguridad_title', 'es_solutions_seguridad_desc', 'es_solutions_cta'
  ]},
